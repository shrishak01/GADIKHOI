    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firebaseAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    Intent intent = new Intent(Activity_register_customer.this, CustomerLoginActivity.class);
...
//registeration vayo
        button_signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (emailID.isEmpty()) {
                    ...
                    Toast.makeText(Activity_register_customer.this, "Please fill everything!", Toast.LENGTH_SHORT).show();
                } else if (!(emailID.isEmpty() && paswd.isEmpty() && user_name.isEmpty() && conpaswd.isEmpty())) {
                    mAuth.createUserWithEmailAndPassword(emailID, paswd).addOnCompleteListener(Activity_register_customer.this, new OnCompleteListener<AuthResult>() {
                        @Override
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (!task.isSuccessful()) {
                                Toast.makeText(Activity_register_customer.this.getApplicationContext(), "Signup unsuccessful:", Toast.LENGTH_SHORT).show();
                            } else {
                                Toast.makeText(Activity_register_customer.this.getApplicationContext(), "Signup successful: Please loginin to access our services", Toast.LENGTH_SHORT).show();
        ...
        txtsignin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Activity_register_customer.this, CustomerLoginActivity.class);
                startActivity(i);
            }
        });
    }
